<template>
  <Tabs v-model:activeKey="activeKey" size="small" @change="handleActiveChange" :tabBarStyle="{ margin: '0px' }">
    <TabPane :key="1" tab="系统">
      <SystemFixedRole @change="handleChange" :modelValue="arrayData.value" :systemDataType="systemDataType" />
    </TabPane>
...
<script lang="ts" setup>
  ...
  import { AnYiExtendInfoArray, AnYiExtendProperty } from '/@/views/bus/flow/types/designercommon.d';

...
<script lang="ts" setup>
    ...
    import {formSchema,busCustomerSpecialListJVxeColumns,busCustomContractJVxeColumns,busContactBillJVxeColumns,busCustomQuotedJVxeColumns,busCustomerLabelJVxeColumns} from '../BusCustomer.data';
    import {saveOrUpdate,queryBusCustomerSpecialList,queryBusCustomContract,queryBusContactBill,queryBusCustomQuoted,queryBusCustomerLabel} from '../BusCustomer.api';

<template>
  <div>
    ...
    <!--字典弹窗-->
    <BusFlowCategoryModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="category-busFlowCategory" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import BusFlowCategoryModal from './components/BusFlowCategoryModal.vue';
  import {columns,searchFormSchema} from './BusFlowCategory.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteBusFlowCategory, batchDeleteBusFlowCategory, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './BusFlowCategory.api';
  ...
  async function handleDelete(record) {
    await deleteBusFlowCategory({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteBusFlowCategory({id: ids}, importSuccess);
  }
  /**
   * 导入
   */

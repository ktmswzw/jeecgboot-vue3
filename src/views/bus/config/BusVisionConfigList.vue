<template>
  <div>
    ...
    <a-tabs defaultActiveKey="1" style="padding: 0 10px">
      <a-tab-pane tab="预制点" key="1">
        <BusVisionPrefabricatedList />
      </a-tab-pane>
      <a-tab-pane tab="通知配置" key="2" forceRender>
        <BusVisionConfigSmsList />
      </a-tab-pane>
    </a-tabs>
    <!-- 表单区域 -->
    <BusVisionConfigModal @register="registerModal" @success="handleSuccess" />
  </div>
</template>
...
<script lang="ts" name="config-busVisionConfig" setup>
  ...
  import BusVisionPrefabricatedList from './BusVisionPrefabricatedList.vue';
  import BusVisionConfigSmsList from './BusVisionConfigSmsList.vue';
